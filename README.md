...
This demo app shows a simple user profile app set up using the following componenets. The application can perform simple tasks like searching for existing profiles, adding new profiles, deleting profiles, and updating profiles. 
- `server.js` (backend) - Handles data storage, talks to MongoDB
- `client.js` (frontend) - Handles user interactions, talks to server
- `index.html` (frontend) - What the user sees and clicks
